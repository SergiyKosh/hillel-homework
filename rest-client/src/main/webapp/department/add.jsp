...
<script type="application/javascript">
    function putData() {
        $.ajax({
            type: "PUT",
            url: "http://127.0.0.1:8080/department/add",
            ...
            <div class="form-floating mt-2">
                <div class="col-md mb-2">
                    <div class="form-floating">
                        <input style="background-color: #6c757d; border: none;" type="text" class="form-control" id="floatingInputGrid" placeholder="Id" name="id">
                ...
                <button type="button" onclick="putData()" class="btn btn-primary">Add new department</button>
            </div>
        </form>
    </div>
</div>
